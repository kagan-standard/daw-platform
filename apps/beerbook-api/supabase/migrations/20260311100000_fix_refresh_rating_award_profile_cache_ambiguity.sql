-- Fix: "column reference user_id is ambiguous" in refresh_rating_award_profile_cache.
-- The RETURNS TABLE columns (user_id, ratings_this_week, week_start, ...) create
-- PL/pgSQL variables that collide with identically-named table columns.
-- #variable_conflict use_column tells the planner to prefer column references.
