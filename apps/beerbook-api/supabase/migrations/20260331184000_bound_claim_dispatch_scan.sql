-- 20260331184000_bound_claim_dispatch_scan.sql
-- Add a 3-day lookback to the INSERT half of claim_push_dispatch_batch
-- so it stops scanning the entire tab_notifications history every 2 minutes.
