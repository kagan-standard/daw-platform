...
<div class="daw-page">
    <div class="daw-logo-area">
        <img src="${url.resourcesPath}/img/logo.jpg" alt="Drinks After Work" class="daw-logo-img">
            ...
            <#if realm.internationalizationEnabled && locale.supported?size gt 1>
                <div class="daw-locale">
                    <#list locale.supported as l>
                        <a href="${l.url}" class="daw-locale-link <#if locale.current = l.label>daw-locale-active</#if>">${l.label}</a><#if l_has_next> </#if>
                    </#list>
                </div>
            </#if>
...
(function() {
    ...
    document.getElementById('daw-tab-login').classList.toggle('daw-tab-active', !isRegister);
    document.getElementById('daw-tab-register').classList.toggle('daw-tab-active', isRegister);
})();
</script>
<script>
(function() {
